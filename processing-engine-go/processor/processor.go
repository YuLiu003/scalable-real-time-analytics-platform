...
func (p *Processor) processData(data models.SensorData) (*models.ProcessedDataPayload, error) {
	...
	// Define variables outside the temperature check
	p.mu.Lock()
	...
	// Update humidity stats if available
...
// ProcessData processes a single piece of data (public version of processData for testing)
func (p *Processor) ProcessData(data models.SensorData) (*models.ProcessedDataPayload, error) {
