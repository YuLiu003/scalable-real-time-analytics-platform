...
| 7 | `feature/jenkins-pipeline-adapter` | Disposable Jenkins Pipeline calling repository-owned quality targets | Clean controller start, gated pipeline, retained evidence, automatic cleanup | Not started |
